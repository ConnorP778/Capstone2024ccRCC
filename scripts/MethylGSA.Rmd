...
results <- mclapply(cgs, function(cpg_site) {
  ...
  #design_formula <- as.formula(paste("~ sex + age + y"))
  design_formula <- as.formula(paste("~y"))
...
#fwrite(results, "/Users/carternorton/Desktop/RCC/result_data/cpg_diff.csv")
```
...
```
```{r}
write.csv(hallmark, "/Users/carternorton/Desktop/RCC/result_data/pathways_results.csv")
```
