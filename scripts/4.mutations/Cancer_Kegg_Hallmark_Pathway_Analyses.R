# script to perform chi square analysis on mutation counts for cancer, kegg, and hallmark pathways (matches original script)
library(dplyr)
...
cancer_pathway_mutation_df <- file.path(base_dir, 'Output/Data/cancer_mut_BMI_analysis.csv')
hallmark_pathway_mutation_df <- file.path(base_dir, 'Output/Data/hallmark_mut_BMI_analysis.csv')
kegg_pathway_mutation_df <- file.path(base_dir, 'Output/Data/kegg_mut_BMI_analysis.csv')
